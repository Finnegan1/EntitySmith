...
const NAV_ITEMS: NavItem[] = [
  ...
  },
  {
    ...
    icon: <Boxes size={16} />,
    group: "main",
    tip: "Decide which source tables represent the same concept. Merge duplicates across sources, define subtypes, or keep them separate. This is where you create canonical entity types and map their attributes.",
  },
  {
    view: "schema-graph",
    label: "Schema Graph",
    ...
    group: "main",
    tip: "Visualize and edit the canonical schema: entity types as nodes and their relationships as edges. The graph reflects the entity types you created and the connections you defined.",
  },
  {
    view: "connections",
    label: "Connections",
    icon: <Cable size={16} />,
    group: "main",
    tip: "Review detected relationships between entity types. The analysis engine finds foreign keys, column-name patterns, and shared sample values to suggest connections. Accept, modify, or reject each proposal.",
  },
  {
    view: "identity",
    label: "Identity",
